...
public class ObjectTransformRotationChangeCommand implements ICommand {

    private Vector3f oldValue;
    private Vector3f newValue;
    private BJEUISettableField settableField;
    private Object3DAbstract o;
    public ObjectTransformRotationChangeCommand(Object3DAbstract o, Vector3f oldValue, Vector3f newValue, BJEUISettableField settableField) {
    ...
    @Override
    public void exec() {
        o.setRotation(newValue);
    }

    @Override
    public void undo() {
        o.setRotation(oldValue);
    }
}
