...
public class ObjectTransformPositionChangeCommand implements ICommand {
    ...
    public ObjectTransformPositionChangeCommand(Object3DAbstract o, Vector3f oldValue, Vector3f newValue, BJEUISettableField settableField) {
    ...
    @Override
    public void exec() {
        o.setLocalPos(newValue);
        settableField.setField(oldValue);
    }

    @Override
    public void undo() {
        o.setLocalPos(oldValue);
    }
}
